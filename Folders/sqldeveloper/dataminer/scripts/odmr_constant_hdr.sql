...
AUTHID CURRENT_USER AS
  ...
  */
  ...
  -- activity state
  WORKFLOW_STATUS_ACTIVE        CONSTANT VARCHAR2(30) := 'ACTIVE';      -- Workflow is being executed
  ...
  WORKFLOW_STATUS_SCHEDULED     CONSTANT VARCHAR2(30) := 'SCHEDULED';   -- Workflow is scheduled (waiting to be run)
