...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://oracle.com/datamodeler/reports/tablesviews" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
				...
				<xsl:for-each select="n1:TablesViews">
					...
					<altova:table>
						...
						<altova:table-row>
							...
							<altova:table-cell altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\sl0">
					...
					<xsl:if test="count(n1:SubViewsCollection)">
						...
						<altova:table>
							...
							<altova:table-row>
								...
								<altova:table-cell altova:character-styles="\b" altova:character-reset-styles="\b0" altova:paragraph-styles="\qc\sl0">
									<altova:TableCellStyles altova:nColSpan="1">
										<xsl:text>\clvertalc</xsl:text>
										<xsl:element name="altova:TableCellColor">
											<xsl:attribute name="altova:sValue" select="'#d9f5ff'"/>
						...
						<xsl:for-each select="n1:TableViewDetails">
							<xsl:choose>
								<xsl:when test="../../n1:UsePageBreaks = &apos;true&apos;">
									<altova:DocumentSection altova:PageWidthPt="841" altova:MarginLeftPt="56" altova:MarginRightPt="56" altova:PageHeightPt="595" altova:MarginTopPt="56" altova:MarginBottomPt="56" altova:Columns="1" altova:ColumnGapPt="0" altova:RtfSectionIntro="\sect\sectd" altova:RtfSectionPageBreak="\sbkpage"/>
									<xsl:text>\facingp\pgwsxn16820\pghsxn11900\lndscpsxn\margtsxn-1120\marglsxn1120\margbsxn-1120\margrsxn1120\headery380\footery380\cols1\colsx0\pgndec</xsl:text>
									<xsl:text>{</xsl:text>
									<xsl:text>\headerl </xsl:text>
									<xsl:call-template name="EmptyHeader"/>
									...
									<altova:table-cell altova:paragraph-styles="\sl0">
										...
										<altova:bookmark name="{n1:ViewName}">
											<xsl:for-each select="n1:ViewName">
												<altova:text-block altova:character-styles="\fs20\b" altova:character-reset-styles="\fs24\b0">
													<xsl:apply-templates/>
												</altova:text-block>
											</xsl:for-each>
										</altova:bookmark>
									...
									<xsl:when test="n1:SelectStatement != &apos;&apos;">
										<altova:table-row>
											...
											<altova:table-cell altova:paragraph-styles="\sl0">
												...
												<altova:paragraph altova:whitespace="preserve-all" altova:selector="pre-wrap" altova:character-styles="\f1\fs24" altova:character-reset-styles="\fs24\f0" altova:is-div="false">
	...
	<xsl:template name="Wide_CRLF">
		...
		<altova:paragraph altova:selector="p" altova:character-styles="\f0\fs24" altova:paragraph-styles="\sl0\sb167\sa167" altova:is-div="false">
			<altova:text-block>
				<xsl:text>\u32?</xsl:text>
			</altova:text-block>
		</altova:paragraph>
	...
	<xsl:template name="Single_CRLF">
		<xsl:param name="templatetablelevel" select="0"/>
		<altova:paragraph altova:selector="div" altova:character-styles="\f0\fs24" altova:is-div="true">
	...
	<xsl:template name="altova:Section_3_FooterRight">
		...
		<altova:table>
			<xsl:variable name="altova:ColumnData"/>
			<altova:TableGrid>
				<altova:GridCol altova:sWidth="11339" altova:sType="twips"/>
					...
					<xsl:for-each select="$XML">
						<xsl:for-each select="n1:TablesViews">
							<xsl:for-each select="n1:CompanyName">
								<altova:text-block altova:character-styles="\f4\fs16\b" altova:character-reset-styles="\f0\fs24\b0">
									<xsl:apply-templates/>
								</altova:text-block>
							</xsl:for-each>
						</xsl:for-each>
	...
	<xsl:variable name="altova:non-xpath-fonts-in-use" select="('Tahoma','Arial','Symbol','Wingdings','Georgia')"/>
