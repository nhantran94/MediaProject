							...
							<xsl:for-each select="n1:TableDetails">
												...
												<a>
													...
													<xsl:choose>
														<xsl:when test="$SV_OutputFormat = &apos;HTML&apos;">
															<xsl:element name="a">
																<xsl:attribute name="href">
																	<xsl:value-of select="concat('#' , n1:TableName , n1:DiagramSuffix)"/>
																</xsl:attribute>
																<xsl:attribute name="name">
																	<xsl:value-of select="n1:TableName"/>
																</xsl:attribute>
								...
								<xsl:if test="count( n1:QuantitativeInfoCollection )">
									<xsl:for-each select="n1:QuantitativeInfoCollection">
										<xsl:call-template name="Single_CRLF"/>
										<table style="border-collapse:collapse; width:8cm; " border="0" cellpadding="3" cellspacing="0">
									...
									<table style="border-collapse:collapse; width:8cm; " border="0" cellpadding="3" cellspacing="0" width="100%">
										...
										<tbody>
											...
											<xsl:for-each select="n1:DiagramsCollection">
												<xsl:variable name="dSuffix" select="n1:DiagramSuffix"/>
																...
																<xsl:when test="$SV_OutputFormat = &apos;HTML&apos;">
																	<xsl:choose>
																		<xsl:when test="../n1:DiagramSuffix != &apos;&apos;">
																			<xsl:element name="a">
																				<xsl:attribute name="href">
																					<xsl:value-of select="concat('#' , $tName , $dSuffix)"/>
																				</xsl:attribute>
																				<xsl:attribute name="name">
								...
								<xsl:if test="count( n1:ConstraintsCollection )">
									...
									<br/>
									<table style="border-collapse:collapse; width:25cm; " border="0" cellpadding="3" cellspacing="0" width="100%">
										<xsl:variable name="altova:CurrContextGrid_9" select="."/>
										<thead style="background-color:#d9f5ff; ">
											<tr style="text-align:center; ">
												<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-left-color:black; border-left-style:solid; border-left-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; font-size:xx-small; font-weight:bold; text-align:center; width:3cm; ">
													<span>
														<xsl:text>Type</xsl:text>
													</span>
												</th>
												<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; font-size:xx-small; font-weight:bold; text-align:center; width:3cm; ">
													<span>
														<xsl:text>Column / Constraint Name</xsl:text>
													</span>
												</th>
												<th style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; border-top-color:black; border-top-style:solid; border-top-width:thin; font-size:xx-small; font-weight:bold; text-align:center; width:19cm; ">
													<span>
														...
														<tr>
															...
															<td style="border-bottom-color:black; border-bottom-style:solid; border-bottom-width:thin; border-right-color:black; border-right-style:solid; border-right-width:thin; font-size:xx-small; vertical-align:top; width:18.50cm; ">
																<xsl:if test="count( n1:RangesCollection ) != 0">
																	<table style="border-collapse:collapse; width:18.5cm; " border="0" cellpadding="3" cellspacing="0">
