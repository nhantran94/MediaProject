...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://oracle.com/datamodeler/reports/tablesviews" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
	...
	<xsl:template name="altova:DocumentSection_0">
		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:TablesViews">
				...
				<xsl:text>\s3\qc\f0\fs24\qc\sl0 </xsl:text>
				...
				<xsl:for-each select="n1:TablesViewsCollection">
					<xsl:for-each select="n1:TableViewDetails">
						...
						<xsl:call-template name="write-text">
							<xsl:with-param name="text">
								<xsl:value-of select="translate(string(n1:ViewName), ' ', '_')"/>
							</xsl:with-param>
						</xsl:call-template>
						<xsl:text>}</xsl:text>
						<xsl:for-each select="n1:ViewName">
							<xsl:text>{\fs20\b </xsl:text>
							<xsl:apply-templates>
						...
						<xsl:choose>
							<xsl:when test="n1:SelectStatement != &apos;&apos;">
								...
								<xsl:text>\itap</xsl:text>
								<xsl:value-of select="$templatetablelevel + 1"/>
								<xsl:text>\ql\sl0\s7\f1\fs24\sl0 </xsl:text>
						...
						<xsl:if test="count( n1:ColumnsCollection )">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(8677.52)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_5_6" select="round(1.14 * 1440 * $altova:TableWidthFactor_5)"/>
							<xsl:text>\par </xsl:text>
							<xsl:text>\pard</xsl:text>
							<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
							<xsl:text>\itap</xsl:text>
						...
						<xsl:if test="count( n1:FKRTCollection )">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_7" select="round(14176.23)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_7_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_7)"/>
							<xsl:variable name="altova:nColumnWidthTw_7_4" select="round(0.79 * 1440 * $altova:TableWidthFactor_7)"/>
						...
						<xsl:if test="count( n1:FKRFCollection )">
							...
							<xsl:variable name="altova:nSumColumnWidthsTw_8" select="round(14176.23)"/>
							...
							<xsl:variable name="altova:nColumnWidthTw_8_3" select="round(0.79 * 1440 * $altova:TableWidthFactor_8)"/>
							<xsl:variable name="altova:nColumnWidthTw_8_4" select="round(0.79 * 1440 * $altova:TableWidthFactor_8)"/>
	...
	<xsl:template name="Wide_CRLF">
		...
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 0"/>
		<xsl:text>\s0\f0\fs24\sl0\sb167\sa167 </xsl:text>
		<xsl:call-template name="write-text">
			<xsl:with-param name="text">
				<xsl:text> </xsl:text>
			</xsl:with-param>
	...
	<xsl:template name="Single_CRLF">
		...
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 0"/>
		<xsl:text>\s1\f0\fs24\sl0 </xsl:text>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		...
		<xsl:variable name="altova:nColumnWidthTw_9_0" select="round(7.87 * 1440 * $altova:TableWidthFactor_9)"/>
		<xsl:variable name="altova:nColumnWidthTw_9_1" select="round(1.18 * 1440 * $altova:TableWidthFactor_9)"/>
		<xsl:variable name="altova:nColumnWidthTw_9_2" select="round(0.79 * 1440 * $altova:TableWidthFactor_9)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:TablesViews">
				<xsl:for-each select="n1:CompanyName">
					<xsl:text>{\f4\fs16\b </xsl:text>
					<xsl:apply-templates>
						<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_9_0 div 1440) - 0.03125 - 0.03125"/>
						<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
					</xsl:apply-templates>
					<xsl:text>}</xsl:text>
				</xsl:for-each>
	...
	<xsl:template name="altova:Section_0_FooterLeft">
		...
		<xsl:variable name="altova:nColumnWidthTw_10_0" select="round(7.87 * 1440 * $altova:TableWidthFactor_10)"/>
		<xsl:variable name="altova:nColumnWidthTw_10_1" select="round(1.18 * 1440 * $altova:TableWidthFactor_10)"/>
		<xsl:variable name="altova:nColumnWidthTw_10_2" select="round(0.79 * 1440 * $altova:TableWidthFactor_10)"/>
		<xsl:text>\pard</xsl:text>
		<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
		<xsl:text>\itap</xsl:text>
		<xsl:value-of select="$templatetablelevel + 1"/>
		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:TablesViews">
				<xsl:for-each select="n1:CompanyName">
					<xsl:text>{\f4\fs16\b </xsl:text>
					<xsl:apply-templates>
						<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_10_0 div 1440) - 0.03125 - 0.03125"/>
						<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
					</xsl:apply-templates>
					<xsl:text>}</xsl:text>
				</xsl:for-each>
