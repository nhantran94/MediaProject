...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://oracle.com/datamodeler/reports/tableview" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype fn iso4217 ix java link n1 sps xbrldi xbrli xlink xs xsd xsi">
		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:TableView">
				...
				<xsl:if test="count( n1:ColumnsCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(8677.52)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_4_6" select="round(1.14 * 1440 * $altova:TableWidthFactor_4)"/>
					<xsl:text>\par </xsl:text>
					<xsl:text>\pard</xsl:text>
					<xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
					<xsl:text>\itap</xsl:text>
				...
				<xsl:if test="count( n1:FKRTCollection )">
					...
					<xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(14176.23)"/>
					...
					<xsl:variable name="altova:nColumnWidthTw_6_4" select="round(0.79 * 1440 * $altova:TableWidthFactor_6)"/>
	...
	<xsl:template name="altova:Section_0_FooterRight">
		...
		<xsl:variable name="altova:nColumnWidthTw_8_0" select="round(7.87 * 1440 * $altova:TableWidthFactor_8)"/>
		...
		<xsl:for-each select="$XML">
			<xsl:for-each select="n1:TableView">
				<xsl:for-each select="n1:CompanyName">
					...
					<xsl:apply-templates>
						<xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_0 div 1440) - 0.03125 - 0.03125"/>
						<xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
					</xsl:apply-templates>
					<xsl:text>}</xsl:text>
				</xsl:for-each>
