...
CURSOR cur_table(v_t_ovid IN VARCHAR2) IS
 SELECT XMLElement(EVALNAME(single_table_prefix || ':TableName'),t.table_name).getClobVal()                                 table_name,
...
CURSOR cur_diagrams(v_t_ovid IN VARCHAR2, v_rep_name IN VARCHAR2) IS
 SELECT XMLElement(EVALNAME(single_table_prefix || ':DiagramName'), v_rep_name || '_files/' || 
...
BEGIN
  ...
  UTL_FILE.PUT_LINE(log_file, TO_CHAR(SYSDATE,'yy.mm.dd hh:mi:ss') ||' '|| 'Gathering single table data started ...');
   ...
   FOR rec_common_data IN cur_common_data(v_table_ovid) LOOP
      ...
      DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':VersionComment>');
      DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':VersionCommentDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_common_data.version_comment||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
          ...
          SELECT XMLElement(EVALNAME(single_table_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
   ...
   IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
      ...
      DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':Description>');
      DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':DescriptionDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
          ...
          SELECT XMLElement(EVALNAME(single_table_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':DescriptionDetails>');
      DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':Description>');
      
      DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':Notes>');
      DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':NotesDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
          ...
          SELECT XMLElement(EVALNAME(single_table_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':NotesDetails>');
      DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':Notes>');
   ...
   IF (reportTemplate.reportType = 0 OR reportTemplate.useTableColumnsComments = 1) THEN
     FOR rec_columns_comments IN cur_columns_comments(v_table_ovid) LOOP
        ...
        END IF;
          ...
          DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':ColumnDescription>');
          DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':ColumnDescriptionDetails>');
          -- Tokenize rows
          FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_columns_comments.description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
              ...
              SELECT XMLElement(EVALNAME(single_table_prefix || ':ColumnDescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
              DBMS_LOB.APPEND (res, token_value);
          END LOOP;
          DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':ColumnDescriptionDetails>');
          DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':ColumnDescription>');

          DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':ColumnNotes>');
          DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':ColumnNotesDetails>');
          -- Tokenize rows
          FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_columns_comments.notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
              ...
              SELECT XMLElement(EVALNAME(single_table_prefix || ':ColumnNoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
              DBMS_LOB.APPEND (res, token_value);
          END LOOP;
          DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':ColumnNotesDetails>');
          DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':ColumnNotes>');
   ...
   IF (reportTemplate.reportType = 0 OR reportTemplate.useTableConstraints = 1) THEN
     ...
     FOR rec_tl_constraints IN cur_tl_constraints(v_table_ovid) LOOP
        ...
        END IF;
          ...
          DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':TLConstraintRule>');
          DBMS_LOB.APPEND (res, '<' || single_table_prefix || ':TLConstraintRuleDetails>');
          -- Tokenize rows
           FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR( rec_tl_constraints.c_details||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
               ...
               SELECT XMLElement(EVALNAME(single_table_prefix || ':TLConstraintRuleRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
               DBMS_LOB.APPEND (res, token_value);
           END LOOP;
           DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':TLConstraintRuleDetails>');       
           DBMS_LOB.APPEND (res, '</' || single_table_prefix || ':TLConstraintRule>');
...
CURSOR cur_all_tables(v_m_ovid IN VARCHAR2) IS
 SELECT /*+ index(t TABLES_FK_IDXV1) */
        XMLElement(EVALNAME(all_tables_prefix || ':TableName'),t.table_name).getClobVal()                                 table_name,
...
-- Diagrams
CURSOR cur_diagrams(v_t_ovid IN VARCHAR2, v_rep_name IN VARCHAR2) IS
 SELECT XMLElement(EVALNAME(all_tables_prefix || ':DiagramName'), v_rep_name || '_files/' || 
             REGEXP_REPLACE(SUBSTR(d.pdf_name, 1, INSTR(d.pdf_name, '.PDF')-1), '[^a-zA-Z1-9_]', '_') || '.pdf').getClobVal()  pdf_name,
        COUNT(d.pdf_name) over()                                                                                               total_row_count
 FROM   dmrs_vdiagrams d,
       (SELECT diagram_ovid 
...
BEGIN
  ...
  DBMS_LOB.APPEND (res,'<' || all_tables_prefix || ':Tables xmlns:' || all_tables_prefix || '="http://oracle.com/datamodeler/reports/tables">');
   ...
   FOR rec_common_data IN cur_common_data(v_model_ovid) LOOP
      ...
      DBMS_LOB.APPEND (res, rec_common_data.design_name);
      DBMS_LOB.APPEND (res, rec_common_data.version_date);  
      DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':VersionComment>');
      DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':VersionCommentDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_common_data.version_comment||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                     FROM   dual
                     CONNECT BY REGEXP_INSTR(rec_common_data.version_comment||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
 
          SELECT XMLElement(EVALNAME(all_tables_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':VersionCommentDetails>');
      DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':VersionComment>');
   ...
   FOR rec_all_tables IN cur_all_tables(v_model_ovid) LOOP
      ...
      IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
         ...
         DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':Description>');
         DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':DescriptionDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_tables_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
         DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':DescriptionDetails>');
         DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':Description>');
         
         DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':Notes>');
         DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':NotesDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_tables_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
         DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':NotesDetails>');
         DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':Notes>');
       ...
       IF (reportTemplate.reportType = 0 OR reportTemplate.useTableColumnsComments = 1) THEN
         FOR rec_columns_comments IN cur_columns_comments(rec_all_tables.table_ovid) LOOP
            ...
            END IF;
              ...
              DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':ColumnDescription>');
              DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':ColumnDescriptionDetails>');
              -- Tokenize rows
              FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_columns_comments.description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                               FROM   dual
                               CONNECT BY REGEXP_INSTR(rec_columns_comments.description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
                  SELECT XMLElement(EVALNAME(all_tables_prefix || ':ColumnDescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
                  DBMS_LOB.APPEND (res, token_value);
              END LOOP;
              DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':ColumnDescriptionDetails>');
              DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':ColumnDescription>');

              DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':ColumnNotes>');
              DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':ColumnNotesDetails>');
              -- Tokenize rows
              FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_columns_comments.notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                               FROM   dual
                               CONNECT BY REGEXP_INSTR(rec_columns_comments.notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
                  SELECT XMLElement(EVALNAME(all_tables_prefix || ':ColumnNoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
                  DBMS_LOB.APPEND (res, token_value);
              END LOOP;
              DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':ColumnNotesDetails>');
              DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':ColumnNotes>');
       ...
       IF (reportTemplate.reportType = 0 OR reportTemplate.useTableConstraints = 1) THEN
         ...
         FOR rec_tl_constraints IN cur_tl_constraints(rec_all_tables.table_ovid) LOOP
            ...
            END IF;
              ...
              DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':TLConstraintRule>');
              DBMS_LOB.APPEND (res, '<'||all_tables_prefix||':TLConstraintRuleDetails>');
              -- Tokenize rows
               FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR( rec_tl_constraints.c_details||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                              FROM   dual
                              CONNECT BY REGEXP_INSTR(rec_tl_constraints.c_details||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
                   SELECT XMLElement(EVALNAME(all_tables_prefix || ':TLConstraintRuleRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
                   DBMS_LOB.APPEND (res, token_value);
               END LOOP;
               DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':TLConstraintRuleDetails>');       
               DBMS_LOB.APPEND (res, '</'||all_tables_prefix||':TLConstraintRule>');
...
-- Diagrams
CURSOR cur_diagrams(v_t_ovid IN VARCHAR2, v_rep_name IN VARCHAR2) IS
  SELECT XMLElement(EVALNAME(single_entity_prefix || ':DiagramName'), v_rep_name || '_files/' || 
             REGEXP_REPLACE(SUBSTR(d.pdf_name, 1, INSTR(d.pdf_name, '.PDF')-1), '[^a-zA-Z1-9_]', '_') || '.pdf').getClobVal()  pdf_name,
        COUNT(d.pdf_name) over()                                                                                               total_row_count
 FROM   dmrs_vdiagrams d,
       (SELECT diagram_ovid 
...
BEGIN
  ...
  DBMS_LOB.APPEND (res,'<' || single_entity_prefix || ':Entity xmlns:' || single_entity_prefix || '="http://oracle.com/datamodeler/reports/entity">');
   ...
   FOR rec_general_data IN cur_general_data(v_entity_ovid) LOOP
      ...
      DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':VersionComment>');
      DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':VersionCommentDetails>');
         -- Tokenize rows
        FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
            ...
            SELECT XMLElement(EVALNAME(single_entity_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
            DBMS_LOB.APPEND (res, token_value);
        END LOOP;
   ...
   IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
     ...
     DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':Description>');
     DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':DescriptionDetails>');
     -- Tokenize rows
     FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                    FROM   dual
                    CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
         SELECT XMLElement(EVALNAME(single_entity_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
         DBMS_LOB.APPEND (res, token_value);
     END LOOP;
     DBMS_LOB.APPEND (res, '</' || single_entity_prefix || ':DescriptionDetails>');
     DBMS_LOB.APPEND (res, '</' || single_entity_prefix || ':Description>');
     
     DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':Notes>');
     DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':NotesDetails>');
     -- Tokenize rows
     FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                    FROM   dual
                    CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
         SELECT XMLElement(EVALNAME(single_entity_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
         DBMS_LOB.APPEND (res, token_value);
     END LOOP;
     DBMS_LOB.APPEND (res, '</' || single_entity_prefix || ':NotesDetails>');
     DBMS_LOB.APPEND (res, '</' || single_entity_prefix || ':Notes>');
   ...
   IF (reportTemplate.reportType = 0 OR reportTemplate.useEntityAttributesComments = 1) THEN
     FOR rec_attributes_comments IN cur_attributes_comments(v_entity_ovid) LOOP
        ...
        END IF;
          ...
          DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':AttributeDescription>');
          DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':AttributeDescriptionDetails>');
          -- Tokenize rows
          FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_attributes_comments.description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
              ...
              SELECT XMLElement(EVALNAME(single_entity_prefix || ':AttributeDescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
              DBMS_LOB.APPEND (res, token_value);
          END LOOP;
          DBMS_LOB.APPEND (res, '</' || single_entity_prefix || ':AttributeDescriptionDetails>');
          DBMS_LOB.APPEND (res, '</' || single_entity_prefix || ':AttributeDescription>');

          DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':AttributeNotes>');
          DBMS_LOB.APPEND (res, '<' || single_entity_prefix || ':AttributeNotesDetails>');
          -- Tokenize rows
          FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_attributes_comments.notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
              ...
              SELECT XMLElement(EVALNAME(single_entity_prefix || ':AttributeNoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
              DBMS_LOB.APPEND (res, token_value);
          END LOOP;
          DBMS_LOB.APPEND (res, '</' || single_entity_prefix || ':AttributeNotesDetails>');
          DBMS_LOB.APPEND (res, '</' || single_entity_prefix || ':AttributeNotes>');
...
-- Diagrams
CURSOR cur_diagrams(v_t_ovid IN VARCHAR2, v_rep_name IN VARCHAR2) IS
 SELECT XMLElement(EVALNAME(all_entities_prefix || ':DiagramName'), v_rep_name || '_files/' || 
             REGEXP_REPLACE(SUBSTR(d.pdf_name, 1, INSTR(d.pdf_name, '.PDF')-1), '[^a-zA-Z1-9_]', '_') || '.pdf').getClobVal()  pdf_name,
        COUNT(d.pdf_name) over()                                                                                               total_row_count
 FROM   dmrs_vdiagrams d,
       (SELECT diagram_ovid 
...
BEGIN
  ...
  FOR rec_general_data IN cur_general_data(v_model_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, rec_general_data.version_date);
       ...
       DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':VersionComment>');
       DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':VersionCommentDetails>');
      
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                      FROM   dual
                      CONNECT BY REGEXP_INSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_entities_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
          END LOOP;
  ...
  END LOOP;
   ...
   FOR rec_all_entities IN cur_all_entities(v_model_ovid) LOOP
      ...
      IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
         ...
         DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':Description>');
         DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':DescriptionDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_entities_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
         DBMS_LOB.APPEND (res, '</' || all_entities_prefix || ':DescriptionDetails>');
         DBMS_LOB.APPEND (res, '</' || all_entities_prefix || ':Description>');
         
         DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':Notes>');
         DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':NotesDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_entities_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
         DBMS_LOB.APPEND (res, '</' || all_entities_prefix || ':NotesDetails>');
         DBMS_LOB.APPEND (res, '</' || all_entities_prefix || ':Notes>');
      ...
      IF (reportTemplate.reportType = 0 OR reportTemplate.useEntityAttributesComments = 1) THEN
        FOR rec_attributes_comments IN cur_attributes_comments(rec_all_entities.entity_ovid) LOOP
           ...
           END IF;
             ...
             DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':AttributeDescription>');
             DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':AttributeDescriptionDetails>');
             -- Tokenize rows
             FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_attributes_comments.description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                            FROM   dual
                            CONNECT BY REGEXP_INSTR(rec_attributes_comments.description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
                 SELECT XMLElement(EVALNAME(all_entities_prefix || ':AttributeDescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
                 DBMS_LOB.APPEND (res, token_value);
             END LOOP;
             DBMS_LOB.APPEND (res, '</' || all_entities_prefix || ':AttributeDescriptionDetails>');
             DBMS_LOB.APPEND (res, '</' || all_entities_prefix || ':AttributeDescription>');

             DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':AttributeNotes>');
             DBMS_LOB.APPEND (res, '<' || all_entities_prefix || ':AttributeNotesDetails>');
             -- Tokenize rows
             FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_attributes_comments.notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                            FROM   dual
                            CONNECT BY REGEXP_INSTR(rec_attributes_comments.notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
                            
                 SELECT XMLElement(EVALNAME(all_entities_prefix || ':AttributeNoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
                 DBMS_LOB.APPEND (res, token_value);
             END LOOP;
             DBMS_LOB.APPEND (res, '</' || all_entities_prefix || ':AttributeNotesDetails>');
             DBMS_LOB.APPEND (res, '</' || all_entities_prefix || ':AttributeNotes>');
...
BEGIN
  ...
  FOR rec_glossary IN cur_glossary(v_glossary_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, '<' || glossary_prefix || ':Description>');
     DBMS_LOB.APPEND (res, '<' || glossary_prefix || ':DescriptionDetails>');
     -- Tokenize rows
     FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_glossary.description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
         ...
         SELECT XMLElement(EVALNAME(glossary_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
         DBMS_LOB.APPEND (res, token_value);
     END LOOP;
     DBMS_LOB.APPEND (res, '</' || glossary_prefix || ':DescriptionDetails>');
     DBMS_LOB.APPEND (res, '</' || glossary_prefix || ':Description>');       
  ...
  FOR rec_glossary_words IN cur_glossary_words(v_glossary_ovid) LOOP
     ...
     END IF;
       ...
       DBMS_LOB.APPEND (res, '<' || glossary_prefix || ':SDescription>');
       DBMS_LOB.APPEND (res, '<' || glossary_prefix || ':SDescriptionDetails>');
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_glossary_words.description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
           ...
           SELECT XMLElement(EVALNAME(glossary_prefix || ':SDescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
           DBMS_LOB.APPEND (res, token_value);
       END LOOP;
       DBMS_LOB.APPEND (res, '</' || glossary_prefix || ':SDescriptionDetails>');
       DBMS_LOB.APPEND (res, '</' || glossary_prefix || ':SDescription>');       
...
-- Diagrams
CURSOR cur_diagrams(v_t_ovid IN VARCHAR2, v_rep_name IN VARCHAR2) IS
 SELECT XMLElement(EVALNAME(single_st_prefix || ':DiagramName'), v_rep_name || '_files/' || 
             REGEXP_REPLACE(SUBSTR(d.pdf_name, 1, INSTR(d.pdf_name, '.PDF')-1), '[^a-zA-Z1-9_]', '_') || '.pdf').getClobVal()  pdf_name,
        COUNT(d.pdf_name) over()                                                                                               total_row_count
 FROM   dmrs_vdiagrams d,
       (SELECT diagram_ovid 
...
BEGIN
  ...
  FOR rec_general_data IN cur_general_data(v_str_type_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, rec_general_data.version_date);
       ...
       DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':VersionComment>');
       DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':VersionCommentDetails>');
      
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                      FROM   dual
                      CONNECT BY REGEXP_INSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(single_st_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
          END LOOP;
  ...
  END LOOP;
   ...
   IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
     ...
     DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':Description>');
     DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':DescriptionDetails>');
     -- Tokenize rows
     FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                    FROM   dual
                    CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
         SELECT XMLElement(EVALNAME(single_st_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
         DBMS_LOB.APPEND (res, token_value);
     END LOOP;
     DBMS_LOB.APPEND (res, '</' || single_st_prefix || ':DescriptionDetails>');
     DBMS_LOB.APPEND (res, '</' || single_st_prefix || ':Description>');
     
     DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':Notes>');
     DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':NotesDetails>');
     -- Tokenize rows
     FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                    FROM   dual
                    CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
         SELECT XMLElement(EVALNAME(single_st_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
         DBMS_LOB.APPEND (res, token_value);
     END LOOP;
   ...
   IF (reportTemplate.reportType = 0 OR reportTemplate.useSTAttributesComments = 1) THEN
     FOR rec_attributes_comments IN cur_attributes_comments(v_str_type_ovid) LOOP
        ...
        END IF;
          ...
          DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':AttributeDescription>');
          DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':AttributeDescriptionDetails>');
          -- Tokenize rows
          FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_attributes_comments.description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                         FROM   dual
                         CONNECT BY REGEXP_INSTR(rec_attributes_comments.description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
              SELECT XMLElement(EVALNAME(single_st_prefix || ':AttributeDescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
              DBMS_LOB.APPEND (res, token_value);
          END LOOP;
          DBMS_LOB.APPEND (res, '</' || single_st_prefix || ':AttributeDescriptionDetails>');
          DBMS_LOB.APPEND (res, '</' || single_st_prefix || ':AttributeDescription>');

          DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':AttributeNotes>');
          DBMS_LOB.APPEND (res, '<' || single_st_prefix || ':AttributeNotesDetails>');
          -- Tokenize rows
          FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_attributes_comments.notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                         FROM   dual
                         CONNECT BY REGEXP_INSTR(rec_attributes_comments.notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
                         
              SELECT XMLElement(EVALNAME(single_st_prefix || ':AttributeNoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
              DBMS_LOB.APPEND (res, token_value);
          END LOOP;
          DBMS_LOB.APPEND (res, '</' || single_st_prefix || ':AttributeNotesDetails>');
          DBMS_LOB.APPEND (res, '</' || single_st_prefix || ':AttributeNotes>');
...
-- Diagrams
CURSOR cur_diagrams(v_t_ovid IN VARCHAR2, v_rep_name IN VARCHAR2) IS
 SELECT XMLElement(EVALNAME(all_st_prefix || ':DiagramName'), v_rep_name || '_files/' || 
             REGEXP_REPLACE(SUBSTR(d.pdf_name, 1, INSTR(d.pdf_name, '.PDF')-1), '[^a-zA-Z1-9_]', '_') || '.pdf').getClobVal()  pdf_name,
        COUNT(d.pdf_name) over()                                                                                               total_row_count
 FROM   dmrs_vdiagrams d,
       (SELECT diagram_ovid 
...
BEGIN
  ...
  FOR rec_general_data IN cur_general_data(v_model_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, rec_general_data.version_date);
       ...
       DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':VersionComment>');
       DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':VersionCommentDetails>');
      
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                      FROM   dual
                      CONNECT BY REGEXP_INSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_st_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
          END LOOP;
  ...
  FOR rec_all_st IN cur_all_st(v_model_ovid) LOOP
      ...
      IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
         ...
         DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':Description>');
         DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':DescriptionDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_st_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
         DBMS_LOB.APPEND (res, '</' || all_st_prefix || ':DescriptionDetails>');
         DBMS_LOB.APPEND (res, '</' || all_st_prefix || ':Description>');
         
         DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':Notes>');
         DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':NotesDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_st_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
      ...
      IF (reportTemplate.reportType = 0 OR reportTemplate.useSTAttributesComments = 1) THEN
        FOR rec_attributes_comments IN cur_attributes_comments(rec_all_st.st_ovid) LOOP
           ...
           END IF;
             ...
             DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':AttributeDescription>');
             DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':AttributeDescriptionDetails>');
             -- Tokenize rows
             FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_attributes_comments.description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                            FROM   dual
                            CONNECT BY REGEXP_INSTR(rec_attributes_comments.description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
                 SELECT XMLElement(EVALNAME(all_st_prefix || ':AttributeDescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
                 DBMS_LOB.APPEND (res, token_value);
             END LOOP;
             DBMS_LOB.APPEND (res, '</' || all_st_prefix || ':AttributeDescriptionDetails>');
             DBMS_LOB.APPEND (res, '</' || all_st_prefix || ':AttributeDescription>');
      
             DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':AttributeNotes>');
             DBMS_LOB.APPEND (res, '<' || all_st_prefix || ':AttributeNotesDetails>');
             -- Tokenize rows
             FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_attributes_comments.notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                            FROM   dual
                            CONNECT BY REGEXP_INSTR(rec_attributes_comments.notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
                            
                 SELECT XMLElement(EVALNAME(all_st_prefix || ':AttributeNoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
                 DBMS_LOB.APPEND (res, token_value);
             END LOOP;
             DBMS_LOB.APPEND (res, '</' || all_st_prefix || ':AttributeNotesDetails>');
             DBMS_LOB.APPEND (res, '</' || all_st_prefix || ':AttributeNotes>');
...
BEGIN
  ...
  FOR rec_general_data IN cur_general_data(v_ct_type_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, rec_general_data.version_date);
       ...
       DBMS_LOB.APPEND (res, '<' || single_ct_prefix || ':VersionComment>');
       DBMS_LOB.APPEND (res, '<' || single_ct_prefix || ':VersionCommentDetails>');
      
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                      FROM   dual
                      CONNECT BY REGEXP_INSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(single_ct_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
          END LOOP;
  ...
  END LOOP;
   ...
   IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
      ...
      DBMS_LOB.APPEND (res, '<' || single_ct_prefix || ':Description>');
      DBMS_LOB.APPEND (res, '<' || single_ct_prefix || ':DescriptionDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                     FROM   dual
                     CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
          SELECT XMLElement(EVALNAME(single_ct_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || single_ct_prefix || ':DescriptionDetails>');
      DBMS_LOB.APPEND (res, '</' || single_ct_prefix || ':Description>');
      
      DBMS_LOB.APPEND (res, '<' || single_ct_prefix || ':Notes>');
      DBMS_LOB.APPEND (res, '<' || single_ct_prefix || ':NotesDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                     FROM   dual
                     CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
          SELECT XMLElement(EVALNAME(single_ct_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || single_ct_prefix || ':NotesDetails>');
      DBMS_LOB.APPEND (res, '</' || single_ct_prefix || ':Notes>');
...
BEGIN
  ...
  FOR rec_general_data IN cur_general_data(v_model_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, rec_general_data.version_date);
       ...
       DBMS_LOB.APPEND (res, '<' || all_ct_prefix || ':VersionComment>');
       DBMS_LOB.APPEND (res, '<' || all_ct_prefix || ':VersionCommentDetails>');
      
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                      FROM   dual
                      CONNECT BY REGEXP_INSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_ct_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
          END LOOP;
  ...
  FOR rec_all_ct_data IN cur_all_ct_data(v_model_ovid) LOOP
      ...
      IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
         ...
         DBMS_LOB.APPEND (res, '<' || all_ct_prefix || ':Description>');
         DBMS_LOB.APPEND (res, '<' || all_ct_prefix || ':DescriptionDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_ct_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
         DBMS_LOB.APPEND (res, '</' || all_ct_prefix || ':DescriptionDetails>');
         DBMS_LOB.APPEND (res, '</' || all_ct_prefix || ':Description>');
         
         DBMS_LOB.APPEND (res, '<' || all_ct_prefix || ':Notes>');
         DBMS_LOB.APPEND (res, '<' || all_ct_prefix || ':NotesDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_ct_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
         DBMS_LOB.APPEND (res, '</' || all_ct_prefix || ':NotesDetails>');
         DBMS_LOB.APPEND (res, '</' || all_ct_prefix || ':Notes>');
...
BEGIN
  ...
  FOR rec_general_data IN cur_general_data(v_dt_type_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, rec_general_data.version_date);
       ...
       DBMS_LOB.APPEND (res, '<' || single_dt_prefix || ':VersionComment>');
       DBMS_LOB.APPEND (res, '<' || single_dt_prefix || ':VersionCommentDetails>');
      
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                      FROM   dual
                      CONNECT BY REGEXP_INSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(single_dt_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
          END LOOP;
  ...
  END LOOP;
   ...
   IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
      ...
      DBMS_LOB.APPEND (res, '<' || single_dt_prefix || ':Description>');
      DBMS_LOB.APPEND (res, '<' || single_dt_prefix || ':DescriptionDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                     FROM   dual
                     CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
          SELECT XMLElement(EVALNAME(single_dt_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || single_dt_prefix || ':DescriptionDetails>');
      DBMS_LOB.APPEND (res, '</' || single_dt_prefix || ':Description>');
      
      DBMS_LOB.APPEND (res, '<' || single_dt_prefix || ':Notes>');
      DBMS_LOB.APPEND (res, '<' || single_dt_prefix || ':NotesDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                     FROM   dual
                     CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
          SELECT XMLElement(EVALNAME(single_dt_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || single_dt_prefix || ':NotesDetails>');
      DBMS_LOB.APPEND (res, '</' || single_dt_prefix || ':Notes>');
...
BEGIN
  ...
  FOR rec_general_data IN cur_general_data(v_model_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, rec_general_data.version_date);
       ...
       DBMS_LOB.APPEND (res, '<' || all_dt_prefix || ':VersionComment>');
       DBMS_LOB.APPEND (res, '<' || all_dt_prefix || ':VersionCommentDetails>');
      
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                      FROM   dual
                      CONNECT BY REGEXP_INSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_dt_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
          END LOOP;
  ...
  FOR rec_all_dt_data IN cur_all_dt_data(v_model_ovid) LOOP
      ...
      IF (reportTemplate.reportType = 0 OR reportTemplate.useDescriptionInfo = 1) THEN
         ...
         DBMS_LOB.APPEND (res, '<' || all_dt_prefix || ':Description>');
         DBMS_LOB.APPEND (res, '<' || all_dt_prefix || ':DescriptionDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_dt_prefix || ':DescriptionRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
         DBMS_LOB.APPEND (res, '</' || all_dt_prefix || ':DescriptionDetails>');
         DBMS_LOB.APPEND (res, '</' || all_dt_prefix || ':Description>');
         
         DBMS_LOB.APPEND (res, '<' || all_dt_prefix || ':Notes>');
         DBMS_LOB.APPEND (res, '<' || all_dt_prefix || ':NotesDetails>');
         -- Tokenize rows
         FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                        FROM   dual
                        CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_dt_prefix || ':NoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
         END LOOP;
         DBMS_LOB.APPEND (res, '</' || all_dt_prefix || ':NotesDetails>');
         DBMS_LOB.APPEND (res, '</' || all_dt_prefix || ':Notes>');
...
BEGIN
  ...
  FOR rec_general_data IN cur_general_data(v_design_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, rec_general_data.version_date);
       ...
       DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':VersionComment>');
       DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':VersionCommentDetails>');
      
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                      FROM   dual
                      CONNECT BY REGEXP_INSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_cr_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
          END LOOP;
  ...
  FOR rec_all_cr IN cur_all_cr(v_design_ovid) LOOP
      ...
      DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':CRComment>');
      DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':CRCommentDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                     FROM   dual
                     CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
          SELECT XMLElement(EVALNAME(all_cr_prefix || ':CRCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || all_cr_prefix || ':CRCommentDetails>');
      DBMS_LOB.APPEND (res, '</' || all_cr_prefix || ':CRComment>');
      
      DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':CRNotes>');
      DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':CRNotesDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                     FROM   dual
                     CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
          SELECT XMLElement(EVALNAME(all_cr_prefix || ':CRNoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || all_cr_prefix || ':CRNotesDetails>');
      DBMS_LOB.APPEND (res, '</' || all_cr_prefix || ':CRNotes>');

      DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':CRReason>');
      DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':CRReasonDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_all_cr.cr_reason||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
          ...
          SELECT XMLElement(EVALNAME(all_cr_prefix || ':CRReasonRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || all_cr_prefix || ':CRReasonDetails>');
      DBMS_LOB.APPEND (res, '</' || all_cr_prefix || ':CRReason>');
      ...
      DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':CRImplementationNote>');
      DBMS_LOB.APPEND (res, '<' || all_cr_prefix || ':CRImplementationNoteDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_imp_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
          ...
          SELECT XMLElement(EVALNAME(all_cr_prefix || ':CRImplementationNoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
          DBMS_LOB.APPEND (res, token_value);
      END LOOP;
      DBMS_LOB.APPEND (res, '</' || all_cr_prefix || ':CRImplementationNoteDetails>');
      DBMS_LOB.APPEND (res, '</' || all_cr_prefix || ':CRImplementationNote>');
...
BEGIN
  ...
  FOR rec_general_data IN cur_general_data(v_design_ovid) LOOP
     ...
     DBMS_LOB.APPEND (res, rec_general_data.version_date);
       ...
       DBMS_LOB.APPEND (res, '<' || all_mr_prefix || ':VersionComment>');
       DBMS_LOB.APPEND (res, '<' || all_mr_prefix || ':VersionCommentDetails>');
      
       -- Tokenize rows
       FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                      FROM   dual
                      CONNECT BY REGEXP_INSTR(rec_general_data.comments||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
             SELECT XMLElement(EVALNAME(all_mr_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
             DBMS_LOB.APPEND (res, token_value);
          END LOOP;
  ...
  IF (reportTemplate.reportType = 0 OR reportTemplate.useMRImpactedObjects = 1) THEN
    FOR rec_all_measurements IN cur_all_measurements(v_design_ovid) LOOP
      ...
      END IF;
        ...
        DBMS_LOB.APPEND (res, '<' || all_mr_prefix || ':MComment>');
        DBMS_LOB.APPEND (res, '<' || all_mr_prefix || ':MCommentDetails>');
        -- Tokenize rows
        FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                       FROM   dual
                       CONNECT BY REGEXP_INSTR(v_description||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
            SELECT XMLElement(EVALNAME(all_mr_prefix || ':MCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
            DBMS_LOB.APPEND (res, token_value);
        END LOOP;
        DBMS_LOB.APPEND (res, '</' || all_mr_prefix || ':MCommentDetails>');
        DBMS_LOB.APPEND (res, '</' || all_mr_prefix || ':MComment>');
        
        DBMS_LOB.APPEND (res, '<' || all_mr_prefix || ':MNotes>');
        DBMS_LOB.APPEND (res, '<' || all_mr_prefix || ':MNotesDetails>');
        -- Tokenize rows
        FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(v_notes||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                       FROM   dual
                       CONNECT BY REGEXP_INSTR(v_notes||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP
            SELECT XMLElement(EVALNAME(all_mr_prefix || ':MNoteRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
            DBMS_LOB.APPEND (res, token_value);
        END LOOP;
        DBMS_LOB.APPEND (res, '</' || all_mr_prefix || ':MNotesDetails>');
        DBMS_LOB.APPEND (res, '</' || all_mr_prefix || ':MNotes>');
...
BEGIN
  ...
  DBMS_LOB.APPEND (res,'<' || all_domains_prefix || ':Domains xmlns:' || all_domains_prefix || '="http://oracle.com/datamodeler/reports/domains">');
   ...
   FOR rec_common_data IN cur_common_data(v_obj_ovid) LOOP
      ...
      DBMS_LOB.APPEND (res, '<' || all_domains_prefix || ':VersionComment>');
      DBMS_LOB.APPEND (res, '<' || all_domains_prefix || ':VersionCommentDetails>');
      -- Tokenize rows
      FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_common_data.version_comment||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
                     FROM   dual
                     CONNECT BY REGEXP_INSTR(rec_common_data.version_comment||Chr(10), '(.*'||Chr(10)||')',1, LEVEL ) > 0) LOOP

           SELECT XMLElement(EVALNAME(all_domains_prefix || ':VersionCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
           DBMS_LOB.APPEND (res, token_value);                   
       END LOOP;
      DBMS_LOB.APPEND (res, '</' || all_domains_prefix || ':VersionCommentDetails>');
      DBMS_LOB.APPEND (res, '</' || all_domains_prefix || ':VersionComment>');
   ...
   FOR rec_all_domains IN cur_all_domains(v_obj_ovid) LOOP
      ...
      END IF;
        ...
        DBMS_LOB.APPEND (res, '<' || all_domains_prefix || ':DomainComment>');
        DBMS_LOB.APPEND (res, '<' || all_domains_prefix || ':DomainCommentDetails>');
        ...
        FOR rec_description IN cur_description(rec_all_domains.domain_ovid) LOOP
           ...
           FOR token IN ( SELECT REGEXP_REPLACE(REGEXP_SUBSTR(rec_description.description||Chr(10), '(.*'||Chr(10)||')', 1, LEVEL ), Chr(10), '') t
               ...
               SELECT XMLElement(EVALNAME(all_domains_prefix || ':DomainCommentRow'), XMLCDATA(token.t)).getClobVal() INTO token_value FROM dual;
               DBMS_LOB.APPEND (res, token_value);                                                                       
           END LOOP;
